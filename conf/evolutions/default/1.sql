...
create table "PHOTO" ("NAME" VARCHAR NOT NULL,"DESCRIPTION" VARCHAR NOT NULL,"DATETIME" TIMESTAMP NOT NULL,"LATITUDE" FLOAT NOT NULL,"LONGITUDE" FLOAT NOT NULL,"PATH" VARCHAR NOT NULL);
create table "TRACK" ("TRACK_ID" OTHER NOT NULL PRIMARY KEY,"TRACK_NAME" VARCHAR);
...
create table "TRACK_POINTS" ("TRACK_ID" OTHER NOT NULL,"LATITUDE" FLOAT NOT NULL,"LONGITUDE" FLOAT NOT NULL,"ELEVATION" FLOAT NOT NULL,"DATE" TIMESTAMP NOT NULL PRIMARY KEY);
