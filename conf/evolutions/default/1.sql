...
create table "DAY_TOUR" ("DATE" DATE NOT NULL,"DAYTOUR_ID" OTHER NOT NULL PRIMARY KEY,"DESCRIPTION" VARCHAR(20000) NOT NULL,"WEATHER_COND" VARCHAR NOT NULL,"ROAD_COND" VARCHAR NOT NULL,"CATEGORY" VARCHAR NOT NULL);
...
create table "TRACK_METADATA" ("TRACK_ID" OTHER NOT NULL PRIMARY KEY,"DESCRIPTION" VARCHAR(20000),"DISTANCE" FLOAT,"TIMERTIME" FLOAT,"TOTALELAPSEDTIME" FLOAT,"MOVINGTIME" FLOAT,"STOPPEDTIME" FLOAT,"MOVINGSPEED" FLOAT,"MAXSPEED" FLOAT,"MAXELEVATION" FLOAT,"MINELEVATION" FLOAT,"ASCENT" FLOAT,"DESCENT" FLOAT,"AVGASCENTRATE" FLOAT,"MAXASCENTRATE" FLOAT,"AVGDESCENTRATE" FLOAT,"MAXDESCENTRATE" FLOAT,"CALORIES" FLOAT,"AVGHEARTREATE" FLOAT);
