...
create table "DAY_TOUR" ("DATE" DATE NOT NULL,"DAYTOUR_ID" OTHER NOT NULL PRIMARY KEY,"DESCRIPTION" VARCHAR NOT NULL,"WEATHER_COND" VARCHAR NOT NULL,"ROAD_COND" VARCHAR NOT NULL,"CATEGORY" VARCHAR NOT NULL);
